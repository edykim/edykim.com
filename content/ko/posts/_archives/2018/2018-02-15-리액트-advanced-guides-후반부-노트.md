...
author: haruair
uuid: "3dd6cbc7-c961-4a37-bbe4-b168070b9be1"
type: post
...
컴포넌트를 부모 컴포넌트의 DOM 트리 바깥에 붙일 때 사용하는 방법이다. 전체화면에 모달 띄우기 이런 동작 필요할 때 쓴다. 아래 코드에서 `child`는 렌더링 가능한 리액트 엘리먼트고 `container`는 DOM 엘리먼트다.
