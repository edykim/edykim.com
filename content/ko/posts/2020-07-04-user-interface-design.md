...
사용자 인터페이스(User Interface, UI) 디자인은 사용자가 할 작업을 예측하고 인터페이스의 엘리먼트에 쉽게 접근할 수 있는지, 이해할 수 있는지, 그리고 손쉽게 사용할 수 있는지에 중점을 둡니다. UI는 상호작용 디자인, 시각 디자인, 정보 아키텍처의 개념을 통합하고 있습니다.
