...
export default ({ info }) => {
  ...
  return (
    <Helmet title={info.frontmatter.title}>
      <html lang={lang} />
      ...
      <meta
        ...
        content={
          info.frontmatter.tags && info.frontmatter.tags.length > 0
            ? info.frontmatter.tags.join(', ')
            : ''
        }
      />
      <meta
        ...
        content={
          info.frontmatter.categories && info.frontmatter.categories.length > 0
            ? info.frontmatter.categories.join(', ')
            : ''
        }
      />
      ...
      <meta
        ...
        content={info.frontmatter.modified || info.frontmatter.date}
      />
      <meta
      ...
      {firstImage ? (
        <meta name="og:image:secure_url" content={firstImage} />
      ) : (
        ''
      )}
    </Helmet>
